...
<body>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0"><?php echo isset($_GET['id']) ? 'Edit Data Poli' : 'Tambah Data Poli'; ?></h3>
                </div>
                <div class="card-body">
                    <form action="" method="POST" onsubmit="return validate();">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_poli" id="nama_poli" class="form-control" 
                                       value="<?php echo $nama_poli; ?>" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if(isset($_GET['id'])): ?>
                                <a href="poli.php" class="btn btn-secondary">
    ...
    <script>
        function validate() {
            const nama_poli = document.getElementById('nama_poli').value.trim();
